-- Prise de rendez-vous dans Calendly : l'agent crée lui-même la réservation par l'API.
...
values (
  ...
  'L''agent propose des créneaux et réserve l''appel sur la page Calendly choisie',
  'hidden'
)
on conflict (key) do nothing;

-- Deux pannes Calendly méritent une notification de compte, pas une par conversation.
