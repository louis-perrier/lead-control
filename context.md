...
- 2026-02-15 : réécriture complète de `src/pages/Dashboard.tsx` pour proposer une page dédiée aux agents Clara (onglets Statistiques/Détails, KPIs, filtres, liste de conversations mockées et chat droit avec quick replies) en se basant uniquement sur des données factices.
# Contexte
